...
//		Thread.sleep(3000);
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Rengarajan Enterprises");
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Renga  Rajan");
